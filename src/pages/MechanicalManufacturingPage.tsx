    ...
    <div className="min-h-screen bg-white text-slate-800 font-sans pb-16">
      ...
      <section className="py-10 sm:py-12 bg-slate-900 text-white border-b border-slate-800">
        <div className="container-versatile">
          ...
          <h1 className="text-2xl sm:text-4xl font-black font-serif text-white mt-1">Mechanical Manufacturing & Testing Strength</h1>
        ...
        <div className="container-versatile">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-7 gap-4">
            ...
            <button
              ...
              className="px-4 py-2 bg-grace-primary text-white text-xs font-bold rounded-xl shadow"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3.5">
            {machineryStrengthList.map((m, idx) => (
              <div key={idx} className="p-3 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-800 shadow-xs flex items-center justify-between">
                <span>{m}</span>
              </div>
            ))}
          </div>
        ...
        <div className="container-versatile">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
            {testingStrengthList.map((t, i) => (
              <div key={i} className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold text-slate-800 flex items-center gap-3">
